...
start(I)-> Refvec=refvec(),S0= getInitialConf(Refvec), I0=h(S0,?M,Refvec),
           if 
               I == I0 -> Pid= spawn(cdistributor, onReceive, [I,true,false,false,0,0,[S0],[]]),
                       register(procName(I),Pid ),io:format("initiator=~w~n",[I0]);

               I /=  I0 -> Pid=spawn(cdistributor,onReceive, [I,false,false,false,0,0,[],[]]), register(procName(I),Pid )
           end.
...
gen(I)-> Pid = spawn(cdistributor, generate, [I]),Pid.
